...
public class RemoteChangeReceiverFreqExecutor extends
		EtherPacketChangeFreqExecutor {
	...
	public void execute(PacketWireless packet, World world, EntityPlayer entityplayer) {
		if (entityplayer.getHeldItem().getItemName().equals(WRemoteCore.itemRemote.getUnlocalizedName())) {
			...
			if (entity instanceof TileEntityRedstoneWirelessR) {
				...
				IWirelessDeviceData devicedata = WirelessDeviceData.getDeviceData(	WirelessRemoteData.class,
																					"Wireless Remote",
				...
				ServerRedstoneEtherPacketHandler.sendEtherTileToAll((TileEntityRedstoneWirelessR) entity,
																	world);
			}
		}
	}
