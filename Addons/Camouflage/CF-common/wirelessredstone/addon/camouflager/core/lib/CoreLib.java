...
public class CoreLib {
	...
	public static final String	CLIENT_PROXY		= "wirelessredstone.addon.camouflager.client.proxy.CamouClientProxy";
	public static final String	COMMON_PROXY		= "wirelessredstone.addon.camouflager.proxy.CamouCommonProxy";
