...
public class PacketCamouflagerCommands {
	public enum camouflagerCommands {
		setBlockRefSide, setBlockRef;
	...
	public static void registerCommands() {
		camouflagerCommands.setBlockRefSide.value = 0;
		camouflagerCommands.setBlockRefSide.name = "setBlockRefSide";
		registerCommand(camouflagerCommands.setBlockRefSide.name);
		camouflagerCommands.setBlockRef.value = 1;
		camouflagerCommands.setBlockRef.name = "setBlockRef";
		registerCommand(camouflagerCommands.setBlockRef.name);
	}

	public static String commandToString(int command) {
		for (camouflagerCommands value : camouflagerCommands.values()) {
